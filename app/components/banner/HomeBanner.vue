<template>
  <div class="relative lg:h-94 w-full">
    <!-- 延伸 Header -->
    <HeaderAdd />
    <!-- 首页图容器 -->
    <div class="relative lg:h-94 overflow-hidden bg-gray-200/30">
      ...
      ></div>
      <img
        class="absolute z-10 lg:-left-4 lg:w-94 transition-all duration-600 linear sm:w-262"
        :class="
          ChengeStore.PlaneOrSolid
            ? 'bottom-100'
            : 'lg:-bottom-192'
