<template>
  ...
  items-center justify-center perspective-1000">
    <!-- technology stack -->
    <div class="flex justify-center items-center h-5/6 w-340 rounded-xl shadow-lg shadow-black/20">
      <div class="
      transition-all duration-600 ease-in-out
      relative flex h-full w-76 group
      bg-white"
      ...
      'rounded-none' : 'rounded-l-xl' ">
        ...
        hover:w-355.5">
            ...
            <div class="
            transition-all duration-600 ease-in-out
            absolute left-0 group-hover:left-68 top-3/10 w-full h-1/2 z-40
      ...
      <div class="
        transition-all duration-600 ease-in-out
        flex relative w-full h-full justify-center
        bg-blue-50/10 overflow-hidden"
        :class="ChengeStore.PlaneOrSolid ?
        'rounded-none' : 'rounded-r-xl' "
      >
          <img class="absolute z-0  w-10/12 -top-30" src="/img/egubule.png" alt="">
          <img class="absolute z-40 w-10/12 -top-30" src="/img/egubuleindex.png" alt="">
      </div>
    </div>
  </div>
</template>
