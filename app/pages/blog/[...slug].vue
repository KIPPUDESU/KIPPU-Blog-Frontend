              ...
              <div class="relative flex flex-col items-start gap-2 lg:flex-row lg:items-center lg:gap-6 w-full h-auto">
                ...
                <div class="flex gap-2 justify-center items-center h-full w-max">
                  ...
                  class="text-gray-300 w-6">
                    <path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2zM9 14H7v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2[...]
                    </path>
                  </svg>
                ...
                <div class="flex gap-2 justify-center items-center h-full w-max">
                  ...
                  viewBox="0 0 24 24"
                  class="text-gray-300 w-6">
                  <path d="M22 5.72l-4.6-3.86l-1.29 1.53l4.6 3.86L22 5.72zM7.88 3.39L6.6 1.86L2 5.71l1.29 1.53l4.59-3.85zM12.5 8H11v6l4.75 2.85l.75-1.23l-4-2.37V8zM12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9a9[...]
                  </path></svg>
                  <span class="text-base lg:text-[20px] text-gray-300">
...
const copyIconSVG = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1[...]
const copiedIconSVG = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19L21 7l-1.41-1.41L9 16.17z" fill="[...]
