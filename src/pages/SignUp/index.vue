...
<template>
  <div class="relative w-full h-screen overflow-hidden flex justify-center items-center">
    <!-- 动态背景层 -->
    <div 
      class="absolute top-0 left-0 w-full h-full transition-all duration-700 ease-in-out bg-gray-100"
    >
    ...
    >
      ...
      <form class="mt-8 space-y-6">
        ...
        <div>
          ...
          <input 
            ...
            class="w-full px-4 py-3 mt-2 outline-none bg-gray-100 border-2 border-gray-200 focus:border-blue-500 focus:bg-white rounded-md text-gray-800"
          >
        </div>
      ...
      <div class="mt-6 text-center">
        <NuxtLink 
          to="/LogIn" 
          class="text-sm font-medium transition-all duration-300 hover:underline text-blue-500 hover:text-blue-700"
        >
          已有账户？立即登录
        </NuxtLink>
      </div>
